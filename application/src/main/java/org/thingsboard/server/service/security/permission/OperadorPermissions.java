...
/**
 * Permissions for OPERADOR authority.
 * Operators have similar permissions to CUSTOMER_USER with additional write capabilities.
 */
@Component
public class OperadorPermissions extends AbstractPermissions {

    public OperadorPermissions() {
        super();
        put(Resource.ALARM, operadorAlarmPermissionChecker);
        put(Resource.ASSET, operadorEntityPermissionChecker);
        put(Resource.DEVICE, operadorEntityPermissionChecker);
        put(Resource.CUSTOMER, customerPermissionChecker);
        put(Resource.DASHBOARD, operadorDashboardPermissionChecker);
        put(Resource.ENTITY_VIEW, operadorEntityPermissionChecker);
        put(Resource.USER, userPermissionChecker);
        put(Resource.WIDGETS_BUNDLE, widgetsPermissionChecker);
        put(Resource.WIDGET_TYPE, widgetsPermissionChecker);
        put(Resource.EDGE, operadorEntityPermissionChecker);
        ...
        put(Resource.TB_RESOURCE, operadorResourcePermissionChecker);
    ...
    private static final PermissionChecker operadorAlarmPermissionChecker = new PermissionChecker() {
        @Override
        public boolean hasPermission(SecurityUser user, Operation operation, EntityId entityId, HasTenantId entity) {
            if (!user.getTenantId().equals(entity.getTenantId())) {
                return false;
            }
            // Operators can acknowledge and clear alarms
            return true;
        }
    };

    private static final PermissionChecker operadorEntityPermissionChecker =
    ...
    private static final PermissionChecker operadorResourcePermissionChecker =
    ...
    private static final PermissionChecker operadorDashboardPermissionChecker =
