...
/**
 * Permissions for REPORTES authority.
 * Reports users have read-only access similar to CUSTOMER_USER.
 */
@Component
public class ReportesPermissions extends AbstractPermissions {

    public ReportesPermissions() {
        super();
        put(Resource.ALARM, reportesAlarmPermissionChecker);
        put(Resource.ASSET, reportesEntityPermissionChecker);
        put(Resource.DEVICE, reportesEntityPermissionChecker);
        put(Resource.CUSTOMER, customerPermissionChecker);
        put(Resource.DASHBOARD, reportesDashboardPermissionChecker);
        put(Resource.ENTITY_VIEW, reportesEntityPermissionChecker);
        put(Resource.USER, userPermissionChecker);
        put(Resource.WIDGETS_BUNDLE, widgetsPermissionChecker);
        put(Resource.WIDGET_TYPE, widgetsPermissionChecker);
        put(Resource.EDGE, reportesEntityPermissionChecker);
        ...
        put(Resource.TB_RESOURCE, reportesResourcePermissionChecker);
    ...
    private static final PermissionChecker reportesAlarmPermissionChecker = new PermissionChecker() {
        @Override
        public boolean hasPermission(SecurityUser user, Operation operation, EntityId entityId, HasTenantId entity) {
            if (!user.getTenantId().equals(entity.getTenantId())) {
                return false;
            }
            // Reports users can only read alarms
            return operation == Operation.READ;
        }
    };

    private static final PermissionChecker reportesEntityPermissionChecker =
    ...
    private static final PermissionChecker reportesResourcePermissionChecker =
    ...
    private static final PermissionChecker reportesDashboardPermissionChecker =
